...
/**
 * write_history - builds a file, or modify an existing file
...
/**
 * build_history_list - input entry to a history linked list
...
/**
 * renumber_history - renumbers the linked list history after changes
